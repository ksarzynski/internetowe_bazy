...
DELETE FROM cinema_db.seats WHERE seat_id<100;
/*
...
INSERT IGNORE INTO cinema_db.cinema_branches VALUES (1, 'add1', 'wro', 'branch1'), (2, 'add2', 'wro', 'branch2'),
                                             (3, 'add3', 'krk', 'branch3');


INSERT IGNORE INTO cinema_db.cinema_halls VALUES (1, 1, 'hall_1_1', 120, 1), (2, 0, 'hall_1_2', 120, 1),
                                          (3, 0, 'hall_2_1', 120, 2), (4, 1, 'hall_3_1', 120, 3);

/*
INSERT IGNORE INTO cinema_db.seats VALUES (1, 1, 1, 1, 12.10, 1), (2, 1, 1, 1, 15.21, 1), (3, 1, 1, 1, 21.37, 1),
...
INSERT INTO cinema_db.seances VALUES(1, '2021-12-20 14:30:00', 100, 40.00, '2021-12-20 12:30:00', 1, 1),
                                     ...
                                     (3, '2021-12-20 19:30:00', 100, 40.00, '2021-12-20 17:30:00', 3, 1);
